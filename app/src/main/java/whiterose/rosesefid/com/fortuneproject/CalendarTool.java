...
public class CalendarTool {
    ...
    public static int gYear; // Year part of a Gregorian date
    public static int gMonth; // Month part of a Gregorian date
    public static int gDay; // Day part of a Gregorian date
    ...
    public void setIranianDate(String jalaliAirDate) {
        ...
        if (year < 1300)
            year += 1300;
        setIranianDate(year, Integer.parseInt(dateSplit[1]), Integer.parseInt(dateSplit[2]));
    }
