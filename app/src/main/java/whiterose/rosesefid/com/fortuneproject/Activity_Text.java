...
public class Activity_Text extends AppCompatActivity implements FragmentTomorrow.OnFragmentInteractionListener,
        FragmentToday.OnFragmentInteractionListener, FragmentText.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (G.TAB_NO == 5) {
            header.setImageResource(mArray_ChineseImages[Activity_Main.selectedPosition]);
        } else {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Activity_Text.super.onBackPressed();
                G.COMPARE_ID = null;
                Activity_Main.mImageView_Compare.setImageResource(R.drawable.ic_help_outline_white_24dp);
            }
        });
                ...
                switch (position) {
                    case 0:
                        if (mCardView_CompareCard.getVisibility() == View.VISIBLE) {
                            animation1 = new TranslateAnimation(0, 170, 0, 0);
...
//                                    mCardView_CompareCard.startAnimation(animation);
                                    ...
                                    handler.postDelayed(new Runnable() {
                                        @Override
                                        public void run() {
                                            mCardView_CompareCard.setVisibility(View.GONE);
                            ...
                            animation.setAnimationListener(new Animation.AnimationListener() {
                                ...
                                public void onAnimationEnd(Animation animation) {
                                    ...
                                    mTextView_And.setVisibility(View.GONE);
...
//                        mTextView_WhatsMySign.setVisibility(View.GONE);
//                        animation = AnimationUtils.loadAnimation(context, R.anim.drive_in);
//                        animation.setFillAfter(true);
//                        mLinearLAyout_FloatLayout.startAnimation(animation);
//                        Log.d("anim", "go");
                        animation1 = new TranslateAnimation(0, -170, 0, 0);
                        animation1.setDuration(200);
