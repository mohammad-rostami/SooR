 ...
 * {@link FragmentYearly.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FragmentYearly#newInstance} factory method to
...
public class FragmentYearly extends Fragment {
    ...
    public static FragmentYearly newInstance(String param1, String param2) {
        FragmentYearly fragment = new FragmentYearly();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerAdapter mRecyclerViewAdapter = new RecyclerAdapter(getContext(), mArrayList_Structs, new OnItemListener() {
            ...
            public void onItemClick(int position) {
                ...
                switch (position) {
                    case 0:
                        G.ID = "96.farvardin.txt";
                        break;
                    case 1:
                        G.ID = "96.ordibehesht.txt";
                        break;
                    case 2:
                        G.ID = "96.khordad.txt";
                        break;
